  ...
  return (
    <div className="flex min-h-screen items-center justify-center bg-slate-50 dark:bg-slate-800 px-5">
      <div className="w-full max-w-sm rounded-3xl bg-white dark:bg-slate-900 p-8 text-center shadow-sm ring-1 ring-slate-100 dark:ring-slate-800">
        <div className="mx-auto grid h-14 w-14 place-items-center rounded-full bg-slate-100 text-slate-500 dark:text-slate-400">
          <XCircle size={28} />
        </div>
        <h1 className="mt-5 text-2xl font-bold text-slate-900 dark:text-white">Pagamento cancelado</h1>
        <p className="mt-2 text-sm text-slate-500 dark:text-slate-400">Não se preocupe, não foi feita nenhuma cobrança.</p>
        <Link
          href="/#planos"
