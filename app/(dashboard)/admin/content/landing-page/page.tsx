  ...
  return (
    <div className="mx-auto max-w-2xl">
      <div className="flex items-center justify-between">
        ...
        <Link href="/" target="_blank" className="text-sm font-semibold text-violet-600 hover:text-violet-800">
          Ver ao vivo
        </Link>
      </div>
      <p className="mt-2 text-slate-500">Edite o título e subtítulo principais mostrados no topo do site.</p>
