-- CreateEnum
CREATE TYPE "Role" AS ENUM ('STUDENT', 'ADMIN', 'INSTRUCTOR', 'DIRECTOR');

-- CreateEnum
CREATE TYPE "EnrollmentStatus" AS ENUM ('ACTIVE', 'COMPLETED', 'EXPIRED', 'CANCELLED', 'BLOCKED');
...
-- CreateEnum
CREATE TYPE "ContentType" AS ENUM ('HERO', 'FEATURES', 'TESTIMONIALS', 'PRICING', 'FAQ', 'CTA');
...
CREATE TABLE "LessonProgress" (
    ...
    "totalTimeWatched" INTEGER NOT NULL DEFAULT 0,
...
-- CreateIndex
CREATE INDEX "CMSContent_contentType_idx" ON "CMSContent"("contentType");
