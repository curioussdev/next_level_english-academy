      ...
      <div className="grid grid-cols-[1fr_auto] gap-4">
        ...
        <div>
          ...
          <select
            ...
            name="rating"
            defaultValue="5"
            className="mt-1 h-11 rounded-xl border border-slate-200 bg-white px-3 text-sm text-slate-900 outline-none focus:border-violet-500 focus:ring-2 focus:ring-violet-100"
          >
            {[5, 4, 3, 2, 1].map((n) => (
